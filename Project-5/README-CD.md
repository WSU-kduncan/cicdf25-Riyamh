...
[Webhook Success](webhook-success.png)
[Git script worked](gitscript-success.png)
[Web page works](webrules-work.png)
- The most frustrating issue ever encountered:
  ...
  [Git rules failed](rules-failed.png)
  [Webhook fail](webhook-fail.png)
  [Web page rules failed](webrules-fail.png)
